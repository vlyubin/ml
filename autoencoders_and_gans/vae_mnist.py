...
class VAE(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc_0 = torch.nn.Linear(784, 400)
        self.fc_1 = torch.nn.Linear(400, 400)

        self.fc_1_1 = torch.nn.Linear(400, 400)
        self.fc_1_2 = torch.nn.Linear(400, 400)

        self.fc_2_1 = torch.nn.Linear(400, 2)
        self.fc_2_2 = torch.nn.Linear(400, 2)

        self.relu = torch.nn.ReLU()
        self.sigmoid = torch.nn.Sigmoid()

        self.dec_fc0 = torch.nn.Linear(2, 400)
        self.dec_fc1 = torch.nn.Linear(400, 784)
...
def manifold_visulisation(model):
    ...
    xs = model.decode(Variable(z))
    utils.save_image(xs.data.resize_((k * k, 1, 28, 28)), latent_sp_file, normalize=True, nrow=k)
